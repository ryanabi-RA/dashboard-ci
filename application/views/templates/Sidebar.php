<!-- Sidebar  -->
<section class="-ml-4 md:ml-0 mr-4 md:p-4 w-fit md:w-64 max-h-screen rounded-tr-xl rounded-br-lg md:rounded-xl bg-white dark:bg-slate-800 shadow-md flex flex-col lg:w-[15%]" id="sidebar">
        <!-- header  -->
        ...
        <ul class="m-auto mt-6 flex-grow flex-col">
            <a href="<?= base_url(''); ?>" class=" ">
                <li class="my-4 md:my-1 p-4 md:p-2 px-5 rounded-lg hover:rounded-lg hover:bg-gray-200 dark:hover:bg-gray-900 flex items-center">
