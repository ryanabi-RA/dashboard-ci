...
<div class="grow m-0 py-2 md:py-4 w-full" id="content">
  <div class="w-full flex flex-col md:flex-wrap md:flex-row">
    <a href="<?php echo base_url('pegawai'); ?>">
      <div class="m-2 md:w-[250px] md:w-[250px] h-auto md:h-[150px] duration-500 drop-shadow-lg rounded-[16px] shadow-md bg-[url('assets/background-vector.jpg')] overflow-hidden">
        <div class="cover py-4 md:py-0 w-full h-full bg-black bg-opacity-0 hover:bg-opacity-50 transition-all duration-1000">
